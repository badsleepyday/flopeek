...
lanes["public-source"] = lanes.full.filter((file) => !["test/contracts/agent-skills-contract.test.js", "test/unit/public-repository-policy.test.js", "test/unit/public-snapshot-workflow.test.js"].includes(file));
