...
| S5 C11 observable stabilization | `partial` | The [six-job public Core matrix](https://github.com/badsleepyday/flowpeek/actions/runs/30156956932) passed on Ubuntu, Windows, and macOS with Node 20 and 22; real local stdio MCP and a single-host Viewer refresh/comparison observation also passed. Manual Viewer/readability/accessibility recovery checks and explicitly scoped independent-provider evidence remain required. |
