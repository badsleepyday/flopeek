...
function resultEnvelope(status, startedAt, discovery, details = {}) {
  ...
  return {
    ...
    limitations: [
      "Worker termination prevents an incomplete analysis result from being returned or promoted; cleanup of adapter child processes is not yet proven across operating systems.",
